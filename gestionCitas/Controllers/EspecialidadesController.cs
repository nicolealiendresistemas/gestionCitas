...
namespace gestionCitas.Controllers
{
    ...
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(GestioncitasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion")] Especialidade especialidade)
        {
